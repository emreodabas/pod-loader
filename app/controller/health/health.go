...
// Handlers manages the set of health endpoints.
...
func (h Handlers) Readiness(w http.ResponseWriter, r *http.Request) {
	...
	if err := response(w, statusCode, "{}"); err != nil {
...
// pkg is deployed to a Kubernetes cluster, it will also return pod, node, and
